...
/**
 * 友達の時間割モックデータ。
 * 将来的には Firestore の users/{uid}/timetable から取得予定。
 */
export const MOCK_FRIEND_TIMETABLES: Record<string, ClassSession[]> = {
  ...
  "4": [
    ...
    { id: "f4-3", day: "火", period: 3, name: "コミュニケーション論", teacher: "斉藤 由紀", room: "3201教室", color: PRESET_COLORS[1] },
    { id: "f4-4", day: "木", period: 5, name: "メディア論", teacher: "林 正人", room: "2501教室", color: PRESET_COLORS[4] },
    { id: "f4-5", day: "土", period: 1, name: "ゼミ（3年）", teacher: "加藤 美咲", room: "演習室B", color: PRESET_COLORS[3] },
  ],
  "5": [
