...
const ja = {
  ...
  "friends.orInvite": "または",
  "friends.lineInvite": "LINEで招待する",
  "friends.lineInviteMessage": "ichiで友達になろう！アプリで私のメールアドレスを検索して友達追加してね😊 メール: {email}",
  "friends.lineNeedAccountTitle": "アカウント登録が必要です",
  "friends.lineNeedAccountBody": "LINE招待にはメールアドレスの登録が必要です。先にアカウント登録をしてください。",
...
const ko: Record<TranslationKey, string> = {
  ...
  "friends.orInvite": "또는",
  "friends.lineInvite": "LINE으로 초대하기",
  "friends.lineInviteMessage": "ichi에서 친구하자! 앱에서 내 이메일을 검색해서 친구추가 해줘😊 이메일: {email}",
  "friends.lineNeedAccountTitle": "계정 등록이 필요해요",
  "friends.lineNeedAccountBody": "LINE 초대는 이메일 등록이 필요해요. 먼저 계정을 등록해주세요.",
